class Principal {
  ...
  Principal() {
    ...
    Cambio[0] = new Boton (530, 460, width/7, height/15);
    Cambio[1] = new Boton (530, 460, width/7, height/15);
    Cambio[2] = new Boton (530, 460, width/7, height/15);
    Cambio[3] = new Boton (530, 460, width/7, height/15);
    Cambio[4] = new Boton (530, 460, width/7, height/15);
    Cambio[5] = new Boton (530, 460, width/7, height/15);
  }
  ...
  void interacion() {
    if (Cambio[0].Clic(530, 460, width/7, height/15) && pantalla == Cambio[0].a) {
      pantalla = Cambio[0].d;
    }
    if (Cambio[1].Clic(530, 460, width/7, height/15) && pantalla == Cambio[1].a) {
      pantalla = Cambio[1].d;
    }
    if (Cambio[2].Clic(530, 460, width/7, height/15) && pantalla == Cambio[2].a) {
      pantalla = Cambio[2].d;
    }
    if (Cambio[3].Clic(530, 460, width/7, height/15) && pantalla == Cambio[3].a) {
      pantalla = Cambio[3].d;
    }
    if (Cambio[4].Clic(530, 460, width/7, height/15) && pantalla == Cambio[4].a) {
      pantalla = Cambio[4].d;
    }
    if (Cambio[5].Clic(530, 460, width/7, height/15) && pantalla == Cambio[5].a) {
      pantalla = Cambio[5].d;
    }
  }
}
